...
####ENV="CRITIC_MODEL=ibm-granite/granite-4.1-3b ${ENV}"  # default: Qwen/Qwen2.5-1.5B-Instruct
...
# @@@ahoaho XXX
#cmd="${ENV}bash examples/train/ppo/run_ppo.sh"
cmd="${ENV}bash examples_mtake/train/ppo/run_ppo_mtake.sh"
