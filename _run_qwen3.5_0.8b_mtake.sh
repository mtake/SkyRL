...
####ENV="POLICY_MODEL=ibm-granite/granite-4.1-3b ${ENV}"  # default: Qwen/Qwen3.5-0.8B
...
# @@@ahoaho XXX
#cmd="${ENV}bash examples/train/models/run_qwen3.5_0.8b.sh"
cmd="${ENV}bash examples_mtake/train/models/run_qwen3.5_0.8b_mtake.sh"
