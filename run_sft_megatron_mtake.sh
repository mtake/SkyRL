...
# Require 4 GPUs
#
# ERR with 4 GPUs. Fails to install skyrl[megatron] due to <cudnn.h> is missing.
#
...
# @@@ahoaho XXX
cmd="${ENV}bash examples/train/sft/run_sft_megatron.sh"
#cmd="${ENV}bash examples/train/sft/run_sft_megatron_mtake.sh"
