...
# ENV="DATA_DIR=${HOME}/data/swe_gym_subset ${ENV}"
# @@@ahoaho XXX TO BE VERIFIED
####ENV="POLICY_MODEL=ibm-granite/granite-4.1-3b ${ENV}"  # default: Qwen/Qwen3-8B
...
# @@@ahoaho XXX
#cmd="${ENV}bash examples/train/mini_swe_agent/run_mini_swe_8B.sh"
cmd="${ENV}bash examples_mtake/train/mini_swe_agent/run_mini_swe_8B_mtake.sh"
