...
#ENV="NUM_INFERENCE_ENGINES=4 ${ENV}"
#ENV="TP_SIZE=1 ${ENV}"
...
# @@@ahoaho XXX
#cmd="${ENV}bash examples/train/llm_as_a_judge/run_llm_judge.sh"
cmd="${ENV}bash examples_mtake/train/llm_as_a_judge/run_llm_judge_mtake.sh"
